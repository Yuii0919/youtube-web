...
export function HistorySidebar() {
  ...
  const handleAddFolder = async () => {
    ...
    try {
      ...
      window.alert(e instanceof Error ? e.message : '新增失敗')
    }
  }
  ...
  const inner = (
    <div className="flex h-full min-h-0 flex-col bg-white/95 dark:bg-zinc-900">
  ...
  return (
    <div className="relative w-0 shrink-0 overflow-visible bg-white dark:bg-zinc-900 md:flex md:h-full md:w-auto md:shrink-0 md:flex-col">
      <button
        type="button"
        className="fixed bottom-4 left-4 z-40 flex h-11 w-11 items-center justify-center rounded-full bg-violet-600 text-white shadow-lg md:hidden"
      ...
      <aside
        className={[
          'z-40 shrink-0 flex-col border-r border-zinc-200/80 bg-white transition-[width] dark:border-zinc-800 dark:bg-zinc-900',
